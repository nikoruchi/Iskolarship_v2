				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="setup_form">
							...
							<button class="btn btn-success btn-block add-sib" id="add-sib-btn">Add Sibling <span class="glyphicon glyphicon-plus"></span></button>
							<hr>
							...
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<button class="btn btn-success btn-block add-rel" class="add-rel-btn">Add Relative <span class="glyphicon glyphicon-plus"></span></button>
								</div>
							</div>
							<hr>
							<div class="col-sm-12">
