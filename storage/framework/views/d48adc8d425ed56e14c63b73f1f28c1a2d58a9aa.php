	...
	<div class="container main-container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				<div class="btn-group flex">
					<a href="<?php echo e(url('/messages/sp',[$sponsor->sponsor_id])); ?>">
						<button class="btn btn-primary"> <span class="glyphicon glyphicon-envelope"></span> Message</button>
					</a>
				</div>
				<?php endif; ?>
				<div>
					<?php if(count($openscholarships) > 0 || count($endscholarships) > 0): ?>
					<h2 class="text-center">Scholarships</h2>
					<ul class="scholarships">					
						<?php if(count($openscholarships) > 0): ?>						
						...
						<?php if(count($endscholarships) > 0): ?>
