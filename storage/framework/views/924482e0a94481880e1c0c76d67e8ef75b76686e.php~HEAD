	...
	<div class="container main-container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				...
				<?php if(Auth::user()->hasRole('student') && (Auth::user()->user_id)==($studentProfile->user_id)): ?>
						...
						<ul class="scholarships">
							...
							<li>
								...
								<article>
									...
									<h5><?php echo e($scho->scholarship_desc); ?></h5>
									<a href="/profile scholarship/<?php echo e($scho->scholarship_id); ?>" class="view"><span class="glyphicon glyphicon-eye-open"></span> View</a>
								</article>
							</li>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</ul>
