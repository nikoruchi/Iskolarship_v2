...
Route::get('/messages/reply', ['middleware'=>'isguest','uses'=>'MessagesController@sendreply']);

Route::get('/messages/mark', ['middleware'=>'isguest','uses'=>'MessagesController@readMessage']);
